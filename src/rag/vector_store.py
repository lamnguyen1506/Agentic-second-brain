    ...
    def __init__(
        ...
        Args:
            persist_directory: Directory to persist the database.
                              Defaults to settings.vector_store.persist_directory.
            collection_name: Name of the collection to use.
                           Defaults to settings.vector_store.collection_name.
        """
        ...
        print(f"Vector store initialized. Collection '{self.collection_name}' ready.")
